...
impl HistoryManager {
    ...
    pub fn update_transcription(
        ...
        let entry = conn
            .query_row(
                "SELECT id, file_name, timestamp, saved, title, transcription_text, post_processed_text, post_process_prompt, post_process_requested, model_id, duration_ms, language
